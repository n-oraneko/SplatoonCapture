...
class CaptureClass:
    ...
    def __init__(self,name) :
        ...
        self.default_width = self.orign_width//2
        self.default_height =self.orign_height//2

        self.cap_width = Value('i',1920)
        self.cap_height = Value('i',1080)
        self.save_name = name
        ...
        while True:
            ...
            try:
                ...
                if ret and salmon_death_waste_count < 0:
                    ...
                    salmon_death_flag = self.save_trim(past_frames,name,ret,salmon_death_flag)
    ...
    def check_color(self,frame,conf):
        frame = cv2.resize(frame,(self.orign_width, self.orign_height))
        for c in conf:
            color = c["color_value"]
            reliability = c["reliability"]
            trim = c["image"]
            tmp_frame = frame[trim[0]:trim[1],trim[2]:trim[3]]
